...
class MyNotes {
  ...
  deleteNote(e) {
    let thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li"); // получаем тэг с атрибутом data-id
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('<li>Imagine real</li>').prependTo("#my-notes").hide().slideDown();
        console.log('Congrats!');
        console.log(response);
      },
      error: response => {
